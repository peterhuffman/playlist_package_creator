...
\\\\\\\\\\\\\\\\\\\\\\\\\Instructions//////////////////////////////////////
    ...
    *** Exporting a .xml file from iTunes ***
    ...
    4. Name the output file, and MAKE SURE TO SAVE IT TO YOUR DESKTOP.
            Note: The filename should be unique, there should not be any directory on your 
                    Desktop that shares its name.
...
\\\\\\\\\\\\\\\\\\\\\\\\\Application Structure/////////////////////////////
    ...
    ~ playlist.rb ~
      ...
      Methods:
        ...
        - choose_playlist: prints the contents of @@xml_files in a menu-format.  Prompts user to choose a playlist.  Only accepst valid integers.
...
\\\\\\\\\\\\\\\\\\\\\\\\\Known Bugs || Solved Bugs/////////////////////////
    ...
    - For some reason, when initializing a new Playlist object, the object variables are not 
        getting re-initialized to their default values.  This means that within the method "create_song_filepaths" the variable @@songs still contains the filepaths of the previous playlist created.  This bug was solved by setting @@songs equal to an empty array previous to adding each playlist's filepaths.